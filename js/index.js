...
function postMessage() { //For posting to server at JSON format
	let user = document.forms.registration-form;
	console.log(
	  user.elements.firstName.value,
	  user.elements.lastName.value,
